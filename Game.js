class Game {
  ...
  async start(){
    ...
    car.scale = 0.3
    car.debug = true
    car.setCollider("rectangle",0,0,120,320)
    car.velocityY = 1
  ...
  play(){
    ...
    if(keyWentDown(LEFT_ARROW)){
      ...
      car.setCollider("rectangle",0,0,320,120)
    ...
    if(car.isTouching(border1)||car.isTouching(border2)||car.isTouching(border3)||car.isTouching(border4)||car.isTouching(border5)||car.isTouching(border6)||car.isTouching(border7)||car.isTouching(border8)||car.isTouching(border9)||car.isTouching(border10)||car.isTouching(border11)||car.isTouching(border12)||car.isTouching(border13)||car.isTouching(border14)||car.isTouching(border15)||car.isTouching(border16)||car.isTouching(ambulanceGroup)||car.isTouching(busGroup)||car.isTouching(tramGroup)){
      ...
      if (frameCount % 300 === 0) {
        ...
        ambulance.setCollider("rectangle",0,0,130,400)
    ...
    fill("BLACK")
    textSize(50)
    text("Game Over, You have Crashed",car.x-350,car.y+100)
  }
}
